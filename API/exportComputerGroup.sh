...
#
# DESCRIPTION
# This script will export a computer group as xml to the Desktop called "Computer-Group-$ID.xml"
#
####################################################################################################
#
...
curl -ksu $username:$password -H "content-type: text/xml" $server/JSSResource/computergroups/id/$id | xmllint -format - > ~/Desktop/Computer-Group-$id.xml
echo "Done!"
