...
#
# DESCRIPTION
# This script will read in parameters and policies from a specified csv list of policy IDs
#
####################################################################################################
#
...
do
	...
	curl -ksu "$username":"$password" -H "content-type: application/xml" "$server"/JSSResource/policies/id/"$id" -X DELETE
done