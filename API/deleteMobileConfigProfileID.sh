...
# DESCRIPTION
#
#	This script will delete (based on ID) a single Mobile Device Configuration Profile in Jamf Pro
#
####################################################################################################
#
...
echo ""
read -p "Movile Device Configuration Profile ID: " cid
####################################################################################################
#
...
curl -ksu $username:$password -H "content-type: text/xml" $server/JSSResource/mobiledeviceconfigurationprofiles/id/"$cid" -X DELETE
